...
parser_process_chat_data = subparsers.add_parser(
    "process_chat_data",
    help=process_chat_data.__doc__.strip(),
    description=process_chat_data.__doc__.strip()
)
parser_process_chat_data.set_defaults(command=process_chat_data)
parser_process_chat_data.add_argument('csv_file', type=str, help='The path to the CSV file containing the chat data.')
